...
In section 3.2, we demonstrated that, at least in the humanities and medicine courses, confusion (or the lack thereof) is significantly correlated with questions, answers, urgency, sentiment and opinion (p < 0.0
1). As such, in predicting confusion, we take into account the predictions of five distinct classifiers, one for each of the aforementioned variables. We use a fine-grained method of combining classifiers in which the outputs of several classifiers are fed as input to a \emph{combination function} \cite{bennett2005combination}. In our case, the combination function is itself a classifier.
...
\begin{table*}
    ...
    Humanities                  & 0.925      & 0.930    & 0.927     &  0.666     & 0.638  & 0.648    & 0.578  \\ \hline
    Medicine                    & 0.958      & 0.950  & 0.953       & 0.615      & 0.599  & 0.586    & 0.542  \\ \hline
    \end{tabular}
    \caption{\textnormal{
       Confusion Classifier Performance. For each course set listed, this table reports the average performance across 10 folds of stratified cross validation. The particular classifier tested here included all features enumerated in section 5.1. 
    }} % title of Table
...
\begin{table*}
       ...
       \hline
       Course                         & $F_{1}$: Not Confused & $F_{1}$: Confused & Kappa \\ \hline\hline
       Economics 1                    & 0.933                 & 0.708             & 0.643 \\ \hline
       Statistical Learning           & 0.911                 & 0.744             & 0.655 \\ \hline
       Statistics in Medicine (2014)  & 0.917                 & 0.721             & 0.640 \\ \hline
       Statistics in Medicine (2013)  & 0.937                 & 0.637             & 0.575 \\ \hline
       Women's Health                 & 0.969                 & 0.530             & 0.502 \\ \hline
       Managing Emergencies           & 0.973                 & 0.400             & 0.393 \\ \hline
       Science Writing                & 0.978                 & 0.407             & 0.388 \\ \hline
       \end{tabular}
       \caption{\textnormal{
       Confusion Classifier Performance, Course Granularity. Our classifier performed best on courses whose discourse was characterized by technical diction, like statistics or economics. In courses that facilitated open-ended and somewhat roaming discussions -- like \emph{Managing Emergencies} or \emph{Science Writing} -- our model found it more difficult to implicitly define confusion. 
       }} % title of Table
...
\begin{table}
       ...
       \begin{tabular}{|c|c|c|}
       \hline
       Training Course                & Test Course                    & Kappa \\ \hline\hline
       Economics 1                    & Economics IV                   & 0.814 \\ \hline
       Statistical Learning           & Statistics 216                 & 0.692 \\ \hline
       Statistics in Medicine (2013)  & Statistics in Medicine (2014)  & 0.617 \\ \hline
       Economics 1                    & Statistics in Medicine (2013)  & 0.359 \\ \hline
       Women's Health                 & Statistics in Medicine (2013)  & 0.311 \\ \hline
       Statistics in Medicine (2013)  & Women's Health                 & 0.084 \\ \hline
       \end{tabular}
       \caption{\textnormal{
