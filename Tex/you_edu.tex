...
\begin{table*}
       ...
       \end{tabular}
       \caption{\textnormal{
       Most Informative Features, Odds Ratios. Features prefixed with ``constituent:'' correspond to the prediction of a constituent classifier, while those prefixed with ``metadata'' correspond to a post metadata feature. All other features are unigram words.
       }} % title of Table
       \label{table:informative_features} % is used to refer this table in the text
\end{table*}

\subsubsection{Constituent Classifiers and Post Metadata: Ablative Analysis}
